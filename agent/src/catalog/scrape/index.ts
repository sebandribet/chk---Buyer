...
export const SCRAPE_TARGETS: ScrapeTarget[] = [
  { canonical: "leche", query: "leche larga vida", category: "alimentos", expectUnits: ["L"], aliases: ["lacteo"], exclude: ["en polvo", "polvo", "condensada", "crema", "chocolatada", "postre", "flan"] },
  { canonical: "cafe", query: "cafe molido", category: "alimentos", expectUnits: ["kg"], aliases: ["cafe en grano"], exclude: ["capsula", "capsulas", "cafetera", "filtro", "taza", "molinillo", "saborizador"] },
  { canonical: "yerba", query: "yerba mate", category: "alimentos", expectUnits: ["kg"], aliases: ["mate"] },
  { canonical: "azucar", query: "azucar", category: "alimentos", expectUnits: ["kg"], exclude: ["edulcorante", "stevia"] },
  { canonical: "harina", query: "harina de trigo", category: "alimentos", expectUnits: ["kg"], exclude: ["premezcla", "rebozador"] },
  { canonical: "arroz", query: "arroz", category: "alimentos", expectUnits: ["kg"], exclude: ["leche de arroz", "galleta", "snack"] },
  { canonical: "avena", query: "avena", category: "alimentos", expectUnits: ["kg"], exclude: ["barra", "galleta", "bebida"] },
  { canonical: "aceite", query: "aceite girasol", category: "alimentos", expectUnits: ["L"], exclude: ["corporal", "capilar", "esencial", "motor", "bebe"] },
  { canonical: "fideos", query: "fideos secos", category: "alimentos", expectUnits: ["kg"], aliases: ["pasta"] },
  { canonical: "sal", query: "sal fina", category: "alimentos", expectUnits: ["kg"], exclude: ["sales de bano", "sal de frutas", "marina gruesa para bano"] },
  { canonical: "detergente", query: "detergente", category: "limpieza", expectUnits: ["L"], aliases: ["lavavajilla"], exclude: ["ropa", "lavarropas", "baby", "prendas", "jabon liquido para ropa"] },
  { canonical: "lavandina", query: "lavandina", category: "limpieza", expectUnits: ["L"], aliases: ["cloro"], exclude: ["pastilla"] },
  { canonical: "jabon liquido", query: "jabon liquido manos", category: "limpieza", expectUnits: ["L"], exclude: ["ropa", "lavarropas"] },
  { canonical: "papel higienico", query: "papel higienico", category: "descartables", expectUnits: ["unidad"], aliases: ["papel"], exclude: ["dispenser", "portarrollo"] },
  { canonical: "rollo de cocina", query: "rollo de cocina", category: "descartables", expectUnits: ["unidad"] },
  { canonical: "servilletas", query: "servilletas de papel", category: "descartables", expectUnits: ["unidad"], exclude: ["dispenser", "femenina", "panuelo", "panuelos"] },
  { canonical: "bolsas de residuo", query: "bolsas de residuos", category: "descartables", expectUnits: ["unidad"], aliases: ["bolsa de basura"], exclude: ["canasto", "cesto de bano"] },

  // --- desayuno y cafetería ------------------------------------------------
  { canonical: "te", query: "te en saquitos", category: "alimentos", expectUnits: ["unidad", "kg"], aliases: ["te en saquitos"], exclude: ["tetera", "infusor", "cafe", "mate cocido"] },
  { canonical: "cacao", query: "cacao en polvo", category: "alimentos", expectUnits: ["kg"], aliases: ["chocolate en polvo"], exclude: ["jugo", "tang", "leche"] },
  { canonical: "dulce de leche", query: "dulce de leche", category: "alimentos", expectUnits: ["kg"], exclude: ["alfajor", "helado", "galleta"] },
  { canonical: "mermelada", query: "mermelada", category: "alimentos", expectUnits: ["kg"], exclude: ["galleta"] },
  { canonical: "miel", query: "miel", category: "alimentos", expectUnits: ["kg"], exclude: ["shampoo", "jabon", "crema"] },
  { canonical: "manteca", query: "manteca", category: "alimentos", expectUnits: ["kg"], exclude: ["cacao", "mani"] },
  { canonical: "crema de leche", query: "crema de leche", category: "alimentos", expectUnits: ["L"], exclude: ["corporal", "facial"] },
  { canonical: "queso crema", query: "queso crema", category: "alimentos", expectUnits: ["kg"], exclude: ["alimento a base de"] },
  { canonical: "galletitas", query: "galletitas", category: "alimentos", expectUnits: ["kg", "unidad"], aliases: ["galletas"] },
  { canonical: "endulzante", query: "edulcorante", category: "alimentos", expectUnits: ["unidad", "kg", "L"], aliases: ["edulcorante"] },

  // --- almacén -------------------------------------------------------------
  { canonical: "tomate triturado", query: "tomate triturado", category: "alimentos", expectUnits: ["kg"], aliases: ["pure de tomate", "salsa de tomate"] },
  { canonical: "atun", query: "atun lata", category: "alimentos", expectUnits: ["kg", "unidad"], exclude: ["gato", "mascota"] },
  { canonical: "aceitunas", query: "aceitunas", category: "alimentos", expectUnits: ["kg"] },
  { canonical: "vinagre", query: "vinagre", category: "alimentos", expectUnits: ["L"], exclude: ["limpieza", "limpiador"] },
  { canonical: "mayonesa", query: "mayonesa", category: "alimentos", expectUnits: ["kg"] },
  { canonical: "ketchup", query: "ketchup", category: "alimentos", expectUnits: ["kg"] },
  { canonical: "mostaza", query: "mostaza", category: "alimentos", expectUnits: ["kg"] },
  { canonical: "pan rallado", query: "pan rallado", category: "alimentos", expectUnits: ["kg"], aliases: ["rebozador"] },
  { canonical: "queso rallado", query: "queso rallado", category: "alimentos", expectUnits: ["kg"], exclude: ["alimento a base de", "untable", "en fetas"] },
  { canonical: "levadura", query: "levadura seca", category: "alimentos", expectUnits: ["kg", "unidad"], exclude: ["cerveza"] },
  { canonical: "polenta", query: "polenta", category: "alimentos", expectUnits: ["kg"] },
  { canonical: "lentejas", query: "lentejas", category: "alimentos", expectUnits: ["kg"], aliases: ["legumbres"] },
  ...
  // arruinaría ese caso.
  { canonical: "agua mineral", query: "agua mineral sin gas", category: "alimentos", expectUnits: ["L"], aliases: ["agua"], exclude: ["saborizada", "tonica"] },
  { canonical: "gaseosa", query: "gaseosa", category: "alimentos", expectUnits: ["L"], aliases: ["refresco"] },
  { canonical: "jugo", query: "jugo exprimido", category: "alimentos", expectUnits: ["L"], exclude: ["polvo", "sobre"] },
  { canonical: "soda", query: "soda sifon", category: "alimentos", expectUnits: ["L"] },

  // --- limpieza ------------------------------------------------------------
  { canonical: "desengrasante", query: "desengrasante cocina", category: "limpieza", expectUnits: ["L"], exclude: ["detergente", "lavavajilla"] },
  { canonical: "limpiador de pisos", query: "limpiador de pisos", category: "limpieza", expectUnits: ["L"], aliases: ["limpiapisos"] },
  { canonical: "limpiavidrios", query: "limpiavidrios", category: "limpieza", expectUnits: ["L"], exclude: ["repuesto", "pano"] },
  { canonical: "alcohol en gel", query: "alcohol en gel", category: "limpieza", expectUnits: ["L"], aliases: ["sanitizante"], exclude: ["lavandina", "desinfectante de ropa"] },
  { canonical: "jabon en polvo", query: "jabon en polvo", category: "limpieza", expectUnits: ["kg"] },
  { canonical: "esponja", query: "esponja cocina", category: "limpieza", expectUnits: ["unidad", "kg"], aliases: ["esponjas"] },
  { canonical: "trapo de piso", query: "trapo de piso", category: "limpieza", expectUnits: ["unidad"], aliases: ["rejilla"] },
  { canonical: "guantes", query: "guantes latex limpieza", category: "limpieza", expectUnits: ["unidad"] },
  ...
  { canonical: "vasos descartables", query: "vasos descartables", category: "descartables", expectUnits: ["unidad"], aliases: ["vaso descartable"] },
  { canonical: "papel aluminio", query: "papel aluminio", category: "descartables", expectUnits: ["unidad"], aliases: ["aluminio"] },
  { canonical: "film", query: "film adherente", category: "descartables", expectUnits: ["unidad"], aliases: ["film adherente"] },
  { canonical: "papel manteca", query: "papel manteca", category: "descartables", expectUnits: ["unidad"] },
];
